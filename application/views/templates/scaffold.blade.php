        ...
        <div class="container">
          ...
          <div class="nav-collapse collapse">
            <ul class="nav">
              ...
              <li class="dropdown">
                <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="icon-tasks"></i> Testes <b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="{{ URL::to('testes'); }}"><i class="icon-tasks"></i> Testes</a></li>
                  <li><a href="{{ URL::to('testes/adicionar'); }}"><i class=" icon-plus"></i> Testes</a></li>
                </ul>
              </li>
            </ul>
